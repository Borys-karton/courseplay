...
function CpManager.saveXmlSettings(self)
	...
	if cpSettingsXml and cpSettingsXml ~= 0 then
		...
		courseplay.globalCourseGeneratorSettings:saveToXML(cpSettingsXml, 'CourseGeneratorSettings')
...
function CpManager:loadXmlSettings()
	...
	if cpSettingsXml and cpSettingsXml ~= 0 then
		...
		courseplay.globalCourseGeneratorSettings:loadFromXML(cpSettingsXml, 'CourseGeneratorSettings')
